...
class UIEdit {
    ...
    private function initExample():Void {
        ...
        element.listItemPrototype = Xml.parse('<element name="Quest" mouseDown="mouseDownHandler" skinId="ui_btn_bottom"><element name="label" skinId="uiFont">Quests</element></element>').firstElement();
